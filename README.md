...
1. Create a GitHub repository, for example `opportunitybridge`.
2. Put the contents of this folder at the repository root, so `index.html` is directly in the root.
...
6. GitHub will provide a public URL such as `https://YOUR-USERNAME.github.io/opportunitybridge/`.
